...
void subarray_of_tables(void)
{
    ...
    /* LOG_S7_DEBUG(0, "object->string actual:", actual_s7str); */
    ...
    /* LOG_S7_DEBUG(0, "expected s7str:", expected_s7str); */
